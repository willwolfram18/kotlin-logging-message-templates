...
// TODO: decide which one to use; can we make it configurable?
private val parser: MessageTemplateParser = RegexMessageTemplateParser()
...
private fun KLogger.atDebugTemplate(throwable: Throwable?, messageTemplate: String, vararg args: Any) = atDebug {
    ...
    cause = throwable
    payload = parser.parseTemplateArguments(messageTemplate, *args)
}
